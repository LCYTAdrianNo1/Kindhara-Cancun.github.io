document.addEventListener('DOMContentLoaded', function() {
    ...
    function showInstallPrompt() {
        ...
        if (deferredPrompt) {
            ...
            // Espera a que el usuario realice un toque en la pantalla antes de mostrar el mensaje de instalación
            ...
            }, { once: true }); // Utiliza { once: true } para asegurarte de que el evento de touchstart se maneje solo una vez
        }
    }
